...
public class Memorama extends AppCompatActivity implements View.OnClickListener{
    ...
    int[] imagenes = {R.drawable.puma,R.drawable.piquero,R.drawable.foca,R.drawable.condor};
    int[] juego = new int[8];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(this,R.raw.condor);
    ...
    class Hilo extends AsyncTask<Void,Integer,Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            {
                imbCarta1.setImageResource(R.drawable.games);
                imbCarta1.setEnabled(true);
            }

            if (juego_terminado[1] == 0)
            {
                imbCarta2.setImageResource(R.drawable.games);
                imbCarta2.setEnabled(true);
            }

            if (juego_terminado[2] == 0)
            {
                imbCarta3.setImageResource(R.drawable.games);
                imbCarta3.setEnabled(true);
            }

            if (juego_terminado[3] == 0)
            {
                imbCarta4.setImageResource(R.drawable.games);
                imbCarta4.setEnabled(true);
            }

            if (juego_terminado[4] == 0)
            {
                imbCarta5.setImageResource(R.drawable.games);
                imbCarta5.setEnabled(true);
            }

            if (juego_terminado[5] == 0)
            {
                imbCarta6.setImageResource(R.drawable.games);
                imbCarta6.setEnabled(true);
            }

            if (juego_terminado[6] == 0)
            {
                imbCarta7.setImageResource(R.drawable.games);
                imbCarta7.setEnabled(true);
            }

            if (juego_terminado[7] == 0)
            {
                imbCarta8.setImageResource(R.drawable.games);
